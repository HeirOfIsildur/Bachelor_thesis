...
\begin{proof}
 ...
 Because the path ends at point $ \left( n,b \right) $, the first step has to be rightwards. Therefore we now have $N=N_{n-1} \left( 1,b \right) -N_{n-1}^0 \left( 1,b \right) \overset{T\ref{thm-reflection_principle}}{=}N_{n-1} \left( 1,b \right) -N_{n-1} \left( -1,b \right).$
...
\begin{proof}
 ...
 \overset{T\ref{thm-probability_maximum_upto_time}}{=}p \left( \pr \left( S_{n-1}=b-1 \right) -\frac{q}{p}\pr \left( S_{n-1}=b+1 \right) \right)\\
...
\begin{proof}
 ...
 \overset{T\ref{thm-ballot_theorem}}{=}2\suma \frac{2i}{2n}\pr \left( S_{2n}=2i \right) =2\suma \frac{2i}{2n}\binom{2n}{n+i}2^{-2n}
 \overset{L\ref{thm-binom_identity}} 2\cdot 2^{-2n}\suma \left( \binom{2n-1}{n-i}-\binom{2n-1}{n-i-1} \right) \overset{**}{=}2\cdot 2^{-2n}\binom{2n-1}{n}
...
\begin{proof}
 ...
 \overset{T\ref{thm-reflection_principle}}{=}\h \h ^{2n-1} \left( N_{2n-1} \left( 1,2r \right) -N_{2n-1} \left( -1,2r \right) \right)\\
...
\begin{proof}
 ...
 \overset{T\ref{thm-temporal_homogeneity}}\h \pr \left( S_1, S_2 \ldots, S_{2n-1}\geq 1 \mid S_0=1 \right)\\
 \overset{T\ref{thm-spatial_homogeneity}}\h \pr \left( S_1, S_2 \ldots, S_{2n-1}\geq 0 \right)\\
 =\h \pr \left( S_1, S_2 \ldots, S_{2n}\geq 0 \right)$. Because $[S_{2n-1}\geq 0] \implies [S_{2n-1}\geq 1] \imples [S_{2n}\geq 0]$
...
\begin{proof}
 ...
 \overset{T\ref{thm-temporal_homogeneity}}{=}\pr \left( S_{1}, S_{2}, \ldots, S_{2 \left( n-k \right) }\neq 0 \right) \pr \left( S_{2k}=0 \right)\\
 \overset{T\ref{thm-probability_no_return}}{=}u_{2 \left( n-k \right) }u_{2k}$
...
\begin{proof}%My own proof
 ...
 %*g indukční předpoklad
 %*h \ref{defn-return_origin}
 %*i factoring out terms not contatining r
 %*j theorem 2.6 Feller
\end{proof}
