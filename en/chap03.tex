...
\begin{lemma}[Probability of being strictly above origin]\label{lemma-probability_strictly_above}
 \Lrws.
 \[
...
\end{proof}
\end{comment}
\begin{lemma}[Probability of being above or in origin]\label{lemma-probability_above_or_on}
  \Lrws. The following equation holds:
 \[
